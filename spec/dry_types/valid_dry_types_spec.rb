...
class WithValidFormTypes
  ...
  json_schema do
    {
      a_nil: Types::Form::Nil,
      a_date: Types::Form::Date,
      a_date_time: Types::Form::DateTime,
      a_time: Types::Form::Time,
      a_true: Types::Form::True,
      a_false: Types::Form::False,
      a_bool: Types::Form::Bool,
      an_int: Types::Form::Int,
      a_float: Types::Form::Float,
      a_decimal: Types::Form::Decimal,
      an_array: Types::Form::Array,
      a_hash: Types::Form::Hash,
    }
  end
...
RSpec.describe 'Dry-types with valid scenarios' do
  ...
  context 'with form types' do
    let(:instance) { WithValidFormTypes.new }
